     ...
     public function ajax_training_Modal() {
        ...
        if ($query->num_rows() > 0) {
            ...
            foreach ($query->result() as $row) {
                ...
                print"<tr><td>" . $sr . "</td><td>" . $this->Common_model->get_name($this, $row->training_id, 'main_new_training', 'training_name') . "</td><td>" . $this->Common_model->show_date_formate($row->proposed_date) . "</td><td>" . $employees . "</td><td>" . $row->training_objective . "</td><td>" . $training_status_array[$row->training_status] . "</td></tr>";
            }
