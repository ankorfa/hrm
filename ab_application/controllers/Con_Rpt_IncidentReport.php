...
class Con_Rpt_IncidentReport extends CI_Controller {
    ...
    public function index($menu_id, $show_result = FALSE, $search_ids = array(), $search_criteria = array('emp_id' => '', 'incident_from' => '', 'incident_to' => '')) {
        ...
        $param['page_header'] = "Incident Report";
        $param['module_id'] = $this->module_id;

        $param['left_menu'] = 'sadmin/hrm_leftmenu.php';
        $param['content'] = 'report/view_Rpt_IncidentReport.php';
