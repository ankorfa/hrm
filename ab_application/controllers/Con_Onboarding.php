    ...
    public function save_Onboarding_personalinformation() {
        ...
        if ($this->user_group == 9) {
            ...
            if ($this->Common_model->unique_check("createdby", $this->user_id, "main_ob_personal_information") == true) {
                echo $this->Common_model->show_validation_massege('This User Already Create onboarding Information. Please Update Your Information.', 2);
                exit();
            }
        }
        ...
        if ($this->candidate_id != 0) {
            if ($this->Common_model->unique_check("candidate_id", $this->candidate_id, "main_ob_personal_information") == true) {
                echo $this->Common_model->show_validation_massege('This Candidate Already Create onboarding information. Please Update Your Information.', 2);
                exit();
            }
        }
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if ($this->input->post('onboarding_employee_id') == "") {
                ...
                if ($res) {
                    ...
                    echo $this->Common_model->show_massege(0, 1) . "_" . $onboarding_employee_id;
                } else {
                    echo $this->Common_model->show_massege(1, 2) . "_" . $onboarding_employee_id;
                }
            } else {
