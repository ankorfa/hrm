...
class Con_Training_Feedback extends CI_Controller {
    ...
    public function index() {
        ...
        if ($this->user_group == 11 || $this->user_group == 12 || $this->user_group == 8 || $this->user_group == 4) {//Hr Manager //Company User //Admin //HR
            ...
            $this->db->select('main_training_status_details.id as did,main_training_status.*,main_training_status_details.*');
            ...
            $this->db->where(array('main_training_status.company_id' => $this->company_id,'main_training_status_details.feedback_status' => 0,'main_training_status.isactive' => 1 ));
            ...
            $this->db->from('main_training_status');
            $this->db->join('main_training_status_details', 'main_training_status.id = main_training_status_details.master_id');
            $this->db->where(array('main_training_status_details.feedback_status' => 0,'main_training_status.isactive' => 1 ));
            $this->db->where_in('main_training_status_details.employee_id', $emp_id);
            $param['query'] = $this->db->get();
        }
        else {
        ...
        $param['content'] = 'training/view_Training_Feedback.php';
