...
class Con_TimeAndAttendance extends CI_Controller {
    ...
    public function index() {
        ...
        if(!$this->module_id){ $param['module_id']=10;}else { $param['module_id']=$this->module_id; }
        ...
        $param['content'] = 'sadmin/view_TimeAndAttendance_dashbord.php';
