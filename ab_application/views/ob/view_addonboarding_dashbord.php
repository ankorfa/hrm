...
<script type="text/javascript">
    //var is_employee = <?php //echo $chk_ob_emp;  ?>;
...
<div class="col-md-10 main-content-div">
    <div class="main-content">
        ...
        <div class="container" style="margin-top:0px; width: 96%; padding-bottom: 15px;">
...
//                    }
                ...
                $("#review_div_save_id").load(location.href + " #review_div_save_id");
    ...
    $(function () {
        $("#onboarding_employmenthistory_form").submit(function (event) {
            ...
            if (save_method == 'add')
            {
                url = "<?php echo site_url('Con_Onboarding/save_onboarding_employmenthistory') ?>";
            } else
            {
                url = "<?php echo site_url('Con_Onboarding/edit_onboarding_employmenthistory') ?>";
            }
    ...
    function edit_ob_employmenthistory(id) {
        ...
        $.ajax({
            url: "<?php echo site_url('Con_Onboarding/ajax_edit_employmenthistory/') ?>/" + id,
            type: "GET",
            dataType: "JSON",
    ...
    function delete_data_ob_employmenthistory(id) {
        ...
        {
            $.ajax({
                url: "<?php echo site_url('Con_Onboarding/delete_entry_employmenthistory/') ?>/" + id,
                type: "POST",
                success: function (data)
                {
                    $("#employmenthistory_div").load(location.href + " #employmenthistory_div");
    ...
    $(function () {
        $("#onboarding_reference_form").submit(function (event) {
            ...
            if (save_method == 'add')
            {
                url = "<?php echo site_url('Con_Onboarding/save_onboarding_reference') ?>";
            } else
            {
                url = "<?php echo site_url('Con_Onboarding/edit_onboarding_reference') ?>";
            }
            $.ajax({
                url: url,
    ...
    function edit_ob_reference(id) {
        ...
        //Ajax Load data from ajax
        $.ajax({
            url: "<?php echo site_url('Con_Onboarding/ajax_edit_reference/') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function (data)
            {
    ...
    function delete_data_ob_reference(id) {
        ...
        {
            $.ajax({
                url: "<?php echo site_url('Con_Onboarding/delete_entry_reference/') ?>/" + id,
                type: "POST",
                success: function (data)
                {
                    $("#ob_reference_div").load(location.href + " #ob_reference_div");
    ...
    $(function () {
        $("#onboarding_education_form").submit(function (event) {
            ...
            if (save_method == 'add')
            {
                url = "<?php echo site_url('Con_Onboarding/save_onboarding_education') ?>";
            } else
            {
                url = "<?php echo site_url('Con_Onboarding/edit_onboarding_education') ?>";
            }
            $.ajax({
                url: url,
    ...
    function edit_ob_education(id) {
        ...
        //Ajax Load data from ajax
        $.ajax({
            url: "<?php echo site_url('Con_Onboarding/ajax_edit_education/') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function (data)
            {
    ...
    function delete_data_ob_education(id) {
        ...
        {
            $.ajax({
                url: "<?php echo site_url('Con_Onboarding/delete_entry_education/') ?>/" + id,
                type: "POST",
                success: function (data)
                {
                    $("#od_education_div").load(location.href + " #od_education_div");
    ...
    $(function () {
        $("#onboarding_criminalhistory_form").submit(function (event) {
            ...
            if (save_method == 'add')
            {
                url = "<?php echo site_url('Con_Onboarding/save_onboarding_criminalhistory') ?>";
            } else
            {
                url = "<?php echo site_url('Con_Onboarding/edit_onboarding_criminalhistory') ?>";
            }
            $.ajax({
                url: url,
    ...
    function edit_ob_criminalhistory(id) {
        ...
        //Ajax Load data from ajax
        $.ajax({
            url: "<?php echo site_url('Con_Onboarding/ajax_edit_criminalhistory/') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function (data)
            {
    ...
    function delete_data_ob_criminalhistory(id) {
        ...
        {
            $.ajax({
                url: "<?php echo site_url('Con_Onboarding/delete_entry_criminalhistory/') ?>/" + id,
                type: "POST",
                success: function (data)
                {
                    $("#ob_criminalhistory_div").load(location.href + " #ob_criminalhistory_div");
    ...
    $(function () {
        $("#onboarding_directdeposit_form").submit(function (event) {
            ...
            //var ckdata = CKEDITOR.instances.directdeposit_text.getData();
            //$('#hidden_directdeposit_text').val(ckdata);

            var url;
            if (save_method == 'add')
            {
                url = "<?php echo site_url('Con_Onboarding/save_onboarding_directdeposit') ?>";
            } else
            {
                url = "<?php echo site_url('Con_Onboarding/edit_onboarding_directdeposit') ?>";
            }
    ...
    function edit_ob_directdeposit(id) {
        ...
        //Ajax Load data from ajax
        $.ajax({
            url: "<?php echo site_url('Con_Onboarding/ajax_edit_directdeposit/') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function (data)
            {
    ...
    function delete_data_ob_directdeposit(id) {
        ...
        {
            $.ajax({
                url: "<?php echo site_url('Con_Onboarding/delete_entry_directdeposit/') ?>/" + id,
                type: "POST",
                success: function (data)
                {
                    $("#ob_directdeposit_div").load(location.href + " #ob_directdeposit_div");
    ...
    function edit_ob_companypolicies(id) {
        save_method = 'update';
        $('#onboarding_companypolicies_form')[0].reset(); // reset form on modals

        //Ajax Load data from ajax
        $.ajax({
            url: "<?php echo site_url('Con_Onboarding/ajax_edit_companypolicies/') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function (data)
            {
    ...
    function delete_data_ob_companypolicies(id) {
        var r = confirm("Do you want to delete this?")
        if (r == true)
        {
            $.ajax({
                url: "<?php echo site_url('Con_Onboarding/delete_entry_companypolicies/') ?>/" + id,
                type: "POST",
                success: function (data)
                {
                    $("#dataTables-example-companypolicies").load(location.href + " #dataTables-example-companypolicies");
    ...
    $(function () {
        $("#obenrolling_form").submit(function (event) {
            ...
            if (save_method == 'add')
            {
                url = "<?php echo site_url('Con_Onboarding/save_onboarding_enrolling') ?>";
            } else
            {
                url = "<?php echo site_url('Con_Onboarding/edit_onboarding_enrolling') ?>";
            }
    ...
    function edit_ob_enrolling(id) {
        ...
        //Ajax Load data from ajax
        $.ajax({
            url: "<?php echo site_url('Con_Onboarding/ajax_edit_enrolling/') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function (data)
            {
    ...
    function delete_data_ob_enrolling(id) {
        ...
        {
            $.ajax({
                url: "<?php echo site_url('Con_Onboarding/delete_entry_enrolling/') ?>/" + id,
                type: "POST",
                success: function (data)
                {
                    $("#ob_enrolling_div").load(location.href + " #ob_enrolling_div");
    ...
    $(function () {
        $("#onboarding_benefit_form").submit(function (event) {
            ...
            if (save_method == 'add')
            {
                url = "<?php echo site_url('Con_Onboarding/save_onboarding_benefit') ?>";
            } else
            {
                url = "<?php echo site_url('Con_Onboarding/edit_onboarding_benefit') ?>";
            }
            ...
            $.ajax({
                ...
                var datas = data.split('_');
                var url = '';
                view_message(datas[0], url, 'ob_benefit_Modal', 'onboarding_benefit_form');
    ...
    function edit_ob_benefit(id) {
        ...
        //Ajax Load data from ajax
        $.ajax({
            url: "<?php echo site_url('Con_Onboarding/ajax_edit_benefit/') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function (data)
            {
    ...
    function delete_data_ob_benefit(id) {
        ...
        {
            $.ajax({
                url: "<?php echo site_url('Con_Onboarding/delete_entry_benefit/') ?>/" + id,
                type: "POST",
                success: function (data)
                {
                    //$("#dataTables-example-benefit").load(location.href + " #dataTables-example-benefit");
    ...
    $(function () {
        $("#save_onboarding_submition_form").submit(function (event) {
            var url = $(this).attr('action');
            $.ajax({
                url: url,
