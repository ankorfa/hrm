    ...
    <div class="main-content">
        ...
        <div class="container tag-box tag-box-v3" style="margin-top:0px; width: 96%; padding-bottom: 15px;">
            ...
            <div id="signupbox" style=" margin-top:10px" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                ...
                <form id="selfuser_signup_form" name="sky-form11" class="form-horizontal" method="post" action="<?php echo base_url(); ?>Con_Onboarding/save_selfuser_signup" enctype="multipart/form-data" role="form">
                    ...
                    <div class="modal-footer">
                        ...
                        <a class="btn btn-danger" href="<?php echo base_url() . "Con_Onboarding/view_onboarding_self_user_function" ?>">Close</a>
                    </div>
                </form>
