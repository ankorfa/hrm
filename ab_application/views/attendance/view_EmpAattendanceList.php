        ...
        <div class="container tag-box tag-box-v3" style="margin-top: 0px; padding-bottom: 15px;"> <!-- container well div -->
            ...
            <form id="att_search" name="att_search" class="form-horizontal" action="" method="post" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group" style="margin-top: 15px;"> 
                    ...
                    <div class="col-sm-3">                            
                        <input type="text" name="start_date" id="start_date" class="form-control dt_pick" placeholder="Date" />                    
                    </div>
                    <label class="col-sm-2 control-label">End Date:</label>
                    <div class="col-sm-3">                            
                        <input type="text" name="end_date" id="end_date" class="form-control dt_pick" placeholder="Date" />                    
                    </div>
                </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="sky-form11" name="sky-form11" class="form-horizontal" action="<?php echo base_url(); ?>Con_AttendanceEntry/save_empAttendance" method="post" enctype="multipart/form-data" role="form">
                <input type="hidden" value="" name="id_attendance" id="id_attendance"/>
                <div class="modal-body"> 
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Department:</label>
                        <div class="col-sm-4">
                            <select name="department_id" id="department_id" onchange="load_emp2(this.value);" class="col-sm-12 col-xs-12 myselect2 input-sm">
                                <option></option>
                                <?php
                                foreach ($department->result() as $row) {
                                    print"<option value=" . $row->id . ">" . $row->department_name . "</option>";
                        ...
                        <label class="col-sm-2 control-label">Employee:</label>
                        <div class="col-sm-4">
                            <select name="employee_id2" id="employee_id2" class="col-sm-12 col-xs-12 myselect2 input-sm">
                                <option></option>
                                <?php
//                                foreach ($department->result() as $row) {
//                                    print"<option value=" . $row->id . ">" . $row->department_name . "</option>";
...
<style type="text/css">
    .bootstrap-timepicker-widget{z-index:1000000001 !important}
</style>
...
<script type="text/javascript">
    ...
    $(function () {
        $("#att_search").submit(function (event) {
            var url;
            url = "<?php echo site_url('Con_EmpAttendanceList/emp_attendance') ?>";
...
//                reload_table('mytable');
    ...
    function load_emp(id) {
        $.ajax({
            url: "<?php echo site_url('Con_EmpAttendanceList/dep_emp/') ?>/" + id,
            async: false,
            type: "POST",
    ...
    function edit_emp_attendance(id) {
        ...
        $.ajax({
            ...
            success: function (data)
            {
                ...
                load_emp2(emp_dep_id);
                $('[name="employee_id2"]').select2().select2('val', data.employee_id);
    ...
    $(function () {
        $("#sky-form11").submit(function (event) {
            ...
            var url;
            url = "<?php echo site_url('Con_EmpAttendanceList/update_emp_attendance') ?>";
