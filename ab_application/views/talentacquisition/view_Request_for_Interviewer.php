                        ...
                        if (!empty($search_ids)) {
                            ...
                            if ($query) {
                                ...
                                foreach ($query->result() as $row) {
                                    ...
                                    $sl++; $pdt = $row->id;
                                    print"<tr>";
                                    print"<td id='catA" . $pdt . "'>" . "<input name='employee_id[]' id='employee_id' type='checkbox' value='$row->employee_id'> <input name='requisition_id' id='requisition_id' type='hidden' value='$requisition_id'>". "</td>";
                                    print"<td id='catA" . $pdt . "'>" . $this->Common_model->employee_name($row->employee_id) . "</td>";
