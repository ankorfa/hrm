...
<!--                    <div class="form-group">
                        ...
                        <div class="col-sm-4"> 
                            <input type="text" name="interview_name" id="interview_name" class="form-control input-sm" placeholder="Interview Name" />
                        </div>
                    </div>-->
...
<!--                            <div class="form-group">
                                <label class="col-sm-2 control-label">Interview Name </label>
                                <div class="col-sm-4"> 
                                    <input type="text" name="interview_name" id="interview_name" value="<?php // echo $i_row->interview_name ?>" class="form-control input-sm" placeholder="Interview Name" />
                                </div>
                            </div>-->
                            <?php
                        }
