    ...
    <div class="main-content">
        ...
        <div class="container tag-box tag-box-v3" style="margin-top: 0px; width: 96%; padding-bottom: 15px;">
            ...
            <div class="col-md-11 col-md-offset-0" style="margin-top: 10px">
                <form id="sky-form11" name="sky-form11"  class="form-horizontal" method="post" action="<?php echo base_url(); ?>Con_Training_Feedback/save_Training_Feedback" enctype="multipart/form-data" role="form" >
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-2 control-label">Participant Name <span class="req"/> </label>
                        <div class="col-sm-4">                            
                            <select name="employee_id" id="employee_id" class="col-sm-12 col-xs-12 myselect2 input-sm">
                                ...
                                $this->db->where(array('main_training_status.training_id ' => $training_id));
                                $trquery = $this->db->get();
                                foreach ($trquery->result() as $trow) {
                                    $emp_name=$this->Common_model->get_selected_value($this,'employee_id',$trow->employee_id,'main_employees','first_name')." ".$this->Common_model->get_selected_value($this,'employee_id',$trow->employee_id,'main_employees','middle_name')." ".$this->Common_model->get_selected_value($this,'employee_id',$trow->employee_id,'main_employees','last_name');
                                    ?>
                                    <option value="<?php echo $trow->employee_id ?>" <?php if ($trow->employee_id == $employee_id ) echo "selected" ?> ><?php echo $emp_name ?></option>
                                    <?php
                                }
                                ?>
                            </select> 
                    ...
                    <div class="modal-footer">                        
                        ...
                        <a class="btn btn-danger" href="<?php echo base_url() . "Con_Training_Feedback" ?>">Close</a>
                    </div>
                </form>
            </div>
                <?php
                 ...
                 ?>
                <div class="col-md-11 col-md-offset-0" style="margin-top: 10px">
                    <form id="sky-form11" name="sky-form11"  class="form-horizontal" method="post" action="<?php echo base_url(); ?>Con_Training_Feedback/update_Training_Feedback" enctype="multipart/form-data" role="form" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">                            
                                <select name="employee_id" id="employee_id" class="col-sm-12 col-xs-12 myselect2 input-sm">
                                    ...
                                    $this->db->from('main_training_status');
                                    $this->db->join('main_training_status_details', 'main_training_status.id = main_training_status_details.master_id');
                                    $this->db->where(array('main_training_status.training_id ' => $row->training_id));
                                    $trquery = $this->db->get();
                                    foreach ($trquery->result() as $trow) {
                                        $emp_name=$this->Common_model->get_selected_value($this,'employee_id',$trow->employee_id,'main_employees','first_name');
                                        ?>
                                        <option value="<?php echo $trow->employee_id ?>" <?php if ($trow->employee_id == $row->employee_id ) echo "selected" ?> ><?php echo $emp_name ?></option>
                                        <?php
                                    }
                                    ?>
                                </select> 
...
<script>
    ...
    $(function () {
        $("#sky-form11").submit(function (event) {
            ...
            $.ajax({
                ...
                var url='<?php echo base_url() ?>Con_Training_Feedback';
    ...
    {
        $.ajax({
          url: "<?php echo site_url('Con_Training_Feedback/load_participant_name/') ?>/" + id,
          async: false,
          type: "POST",
