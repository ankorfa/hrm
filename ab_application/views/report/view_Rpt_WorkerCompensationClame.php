    ...
    <div class="main-content">
        ...
        <div class="container tag-box tag-box-v3" style="margin-top: 0px; width: 96%; padding-bottom: 15px;"> <!-- container well div -->
            <div class="table-responsive col-md-12 col-centered">
                ...
                <form class="form-horizontal" action="<?php echo base_url() . 'Con_Rpt_WorkerCompensationClaim/get_WorkerCompensationClaim_data/' . $menu_id; ?>" method="post">
                    <div class="row">
                        <div class="col-sm-4">
...
//                                        print "<a title='Employee Accident Report' href='" . base_url() . 'con_Employees/accident_report/' . $row->id . "'><i class='fa fa-lg fa-arrow-down'></i></a>&nbsp;&nbsp;"
                                        print "<a title='WORKERS’ COMPENSATION CLAIM' href='" . base_url() . 'Con_Employees/work_comp_claim/' . $row->action_id . "'><i class='fa fa-download' aria-hidden='true'></i></a>&nbsp;&nbsp;"
                                        ?>                                    
                                    </td>
                                </tr>
                                <?php
