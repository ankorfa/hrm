<div class="col-md-10 main-content-div">
    <div class="main-content">
        ...
        <div class="container tag-box tag-box-v3" style="padding:15px;">
            ...
            if ($type == 1) {//entry
                ?>
            <form id="sky-form11" name="sky-form11"  class="form-horizontal" method="post" action="<?php echo base_url(); ?>con_UserGroup/save_userGroup" enctype="multipart/form-data" role="form" >
            ...
            <form id="sky-form11" name="sky-form11"  class="form-horizontal" method="post" action="<?php echo base_url(); ?>con_UserGroup/edit_UserGroup" enctype="multipart/form-data" role="form" >
                    <?php foreach ($query->result() as $row): ?> 
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6 find_mar">
                                <label class="control-label pull-left">Group Name</label>
                                <input type="text" name="group_name" id="group_name" value="<?php echo ucwords($row->group_name) ?>" class="form-control" placeholder="Group Name" />
                            </div> 
                            <div class="col-md-3 col-sm-6 find_mar">
                                <label class="control-label pull-left">Description</label>
