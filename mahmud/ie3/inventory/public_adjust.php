...
{
	if (isset($_SESSION['public_item']))
	{
		$_SESSION['public_item']->clear_items();
		unset ($_SESSION['public_item']);
	}
       
    $_SESSION['public_item'] = new items_cart(ST_INVADJUST);
	$_POST['AdjDate'] = new_doc_date();
	if (!is_date_in_fiscalyear($_POST['AdjDate']))
		$_POST['AdjDate'] = end_fiscalyear();
	$_SESSION['public_item']->tran_date = $_POST['AdjDate'];	
}
...
function handle_new_item()
{
	...
	add_to_order($_SESSION['public_item'], $_POST['stock_id'], 
	  input_num('qty'), input_num('std_cost'));
	 //display_error(print_r($_SESSION['adj_items'],1));
        line_start_focus();
...
if (isset($_GET['NewAdjustment']) || !isset($_SESSION['public_item']))
{
	handle_new_order();
}
...
//display_order_header($_SESSION['adj_items']);//akhane session ar kaj ke
...
display_adjustment_public(_("Public Adjustment Name"), $_SESSION['public_item']);
