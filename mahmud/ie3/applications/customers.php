...
class customers_app extends application {
    ...
    function customers_app() {
        ...
        $this->add_rapp_function(1, _("Simple CRUD"), "crud/emp_list.php?Class=0", 'SA_SALESTRANSVIEW', MENU_REPORT);
        $this->add_rapp_function(1, _("DB Pager CRUD"), "crud/emp_data_list.php?Class=0", 'SA_SALESTRANSVIEW', MENU_REPORT);
        $this->add_rapp_function(1, _("Simple CART Page"), "crud/cart_page.php?NewEmployee=1", 'SA_SALESTRANSVIEW', MENU_REPORT);

        $this->add_module(_("Maintenance"));
        $this->add_lapp_function(2, _("Add and Manage &Customers"), "sales/manage/customers.php?", 'SA_CUSTOMER', MENU_ENTRY);
        //MY CREATE MENU BAR
        $this->add_lapp_function(2, _("Add and Manage &Employeer"), "sales/manage/employee.php?", 'SA_CUSTOMER', MENU_ENTRY);
