		...
		if ($dim > 0)
		{
			...
			$this->add_lapp_function(0, _("Dimension &Entry"),
				"dimensions/dimension_entry.php?", 'SA_DIMENSION', MENU_ENTRY);
                        ...
                        $this->add_lapp_function(0, _("Dimension &Entry ByManik"),
				"dimensions/dimension_entry_bymanik.php?", 'SA_DIMENSION', MENU_ENTRY);
			$this->add_lapp_function(0, _("&Outstanding Dimensions"),
				"dimensions/inquiry/search_dimensions.php?outstanding_only=1", 'SA_DIMTRANSVIEW', MENU_TRANSACTION);
                        $this->add_lapp_function(0, _("&Outstanding Dimensions byManik"),
				"dimensions/inquiry/search_dimensions_bymanik.php?outstanding_only=1", 'SA_DIMTRANSVIEW', MENU_TRANSACTION);
                         $this->add_lapp_function(0, _("&Show Employee byManik"),
				"dimensions/inquiry/search_employee_manik.php?outstanding_only=1", 'SA_DIMTRANSVIEW', MENU_TRANSACTION);
