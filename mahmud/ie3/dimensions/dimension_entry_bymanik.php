...
if (isset($_POST['ADD_ITEM']) || isset($_POST['UPDATE_ITEM'])) 
{
	...
	if (can_process()) 
	{
		...
		if ($selected_id == -1) 
		{
                    display_error($_POST['textrow']);
			$id = add_dimensions($_POST['ref'], $_POST['name'], $_POST['type_'], $_POST['date_'], $_POST['due_date'],$_POST['textrow'], $_POST['memo_']);
...
text_row_ex(_("New Text Row") . ":", 'textrow', 50, 60);
