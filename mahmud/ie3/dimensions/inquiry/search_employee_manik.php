...
function edit_link($row)
{
	...
	return pager_link(_("Edit"),
			"/dimensions/dimension_entry_bymanik.php?trans_no=" . $row["id"], ICON_EDIT);
}

//$sql = get_sql_for_search_dimensions($dim);
$sql=  get_sql_for_search_employee($dim);
$cols = array(
	_("EmployeeId"),
	_("Employee Name"), 
	_("Employee Father"), 
	_("Address"), 
	_("Date of Birht") =>'date', 
        _("Department Name"),
	_("Education"),
...
$table =& new_db_pager('dim_tbl', $sql, $cols,null, null, 5);
